...
<div id="content">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label" for="input-order-id">Store</label>
                                <select name="filter_store_id" id="input-order-status" class="form-control">
                                    <option value="*"></option>
                                    <?php foreach ($stores as $order_store) { ?>
                                    <?php if ($order_store['store_id'] == $filter_store_id and $filter_store_id !='' and $filter_store_id !='*') { ?>
    ...
    <script type="text/javascript"><!--
        $('#button-filter').on('click', function() {
            url = 'index.php?route=module/openpos/orders&token=<?php echo $token; ?>';
