				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-<?php echo $span; ?> col-xs-6 footer-panel">
							<h4><?php echo $text_extra; ?></h4>
							<div class="strip-line"></div>
							<div class="fb-page" data-href="https://www.facebook.com/NutricaoCenter" data-tabs="timeline" data-height="220" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/NutricaoCenter"><a href="https://www.facebook.com/NutricaoCenter">Nutrição Esportiva</a></blockquote></div></div>
						</div>

						<div class="col-sm-<?php echo $span; ?> col-xs-6 footer-panel">
							<h4><?php echo $text_payments; ?></h4>
							<div class="strip-line"></div>
							<img src="./catalog/view/theme/cosmeticcubes/img/cartoes-credito-suplementos-rodape.png" alt="Cartões de Crédito"/>
						</div>
