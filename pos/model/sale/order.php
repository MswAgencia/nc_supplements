...
class ModelSaleOrder extends Model {
	public function addOrder($data,$subtract = false) {
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET date_added  = '" . date('Y-m-d H:i:s',$data['invoice_no']) . "' WHERE order_id = '" . (int)$order_id . "'");
	...
	public function CheckOrderExits($invoice_no)
	{
		$query = $this->db->query("SELECT COUNT(*) AS total,order_id FROM `" . DB_PREFIX . "order` WHERE invoice_no = '" . (int)$invoice_no . "'");
		if($query->row['total'])
		{
