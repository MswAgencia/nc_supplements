...
class ModelSaleCustomer extends Model {
    ...
    {
        $sql = "SELECT DISTINCT * FROM " . DB_PREFIX . "customer WHERE LCASE(email) LIKE '%" . $this->db->escape(utf8_strtolower($rule)) . "%' OR  LCASE(firstname) LIKE '%" . $this->db->escape(utf8_strtolower($rule)) . "%' OR  LCASE(lastname) LIKE '%" . $this->db->escape(utf8_strtolower($rule)) . "%' OR  LCASE(telephone) LIKE '%" . $this->db->escape(utf8_strtolower($rule)) . "%'";
